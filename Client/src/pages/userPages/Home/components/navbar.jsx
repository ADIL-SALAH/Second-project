...
//     const { name, username, image, state, wallet } = useSelector((state) => state.client)
...
//                     <span className='text-yellow-500 hover:cursor-pointer ' onClick={() => navigate('/cart')}><FontAwesomeIcon icon={faCartShopping} /></span>
//                     : null}
...
//                                     href="#"
//                                     data-te-dropdown-item-ref onClick={() => handleTabClick('userProfile')}>Profile</li>
//                                 <li className="block w-full whitespace-nowrap bg-transparent px-4 py-2 text-sm font-normal text-neutral-700 hover:bg-neutral-100 active:text-neutral-800 active:no-underline disabled:pointer-events-none disabled:bg-transparent disabled:text-neutral-400 dark:text-neutral-200 dark:hover:bg-neutral-600"
//                                     href="#"
                        ...
                        {isLoggedIn ? (
                            <>
                                {image ? (
                                    ...
                                    <FontAwesomeIcon
                                        className="text-gray-600 mr-5 h-4 w-6"
                                        icon={faUser}
                                    />
                                )}
                            </>
